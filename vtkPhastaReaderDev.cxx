...
vtkStandardNewMacro(vtkPhastaReaderDev);

vtkCxxSetObjectMacro(vtkPhastaReaderDev, CachedGrid, vtkUnstructuredGrid);
...
char* vtkPhastaReaderDev::StringStripper( const char  istring[] ) 
{
...
int vtkPhastaReaderDev::cscompare( const char teststring[], 
...
void vtkPhastaReaderDev::isBinary( const char iotype[] ) 
{
...
size_t vtkPhastaReaderDev::typeSize( const char typestring[] ) 
{
...
int vtkPhastaReaderDev::readHeader( FILE*       fileObject,
                               const char  phrase[],
                               int*        params,
                               int         expect ) 
{
...
void vtkPhastaReaderDev::SwapArrayByteOrder( void* array, 
                                         int   nbytes, 
                                         int   nItems ) 
{
...
void vtkPhastaReaderDev::openfile( const char filename[],
                              const char mode[],
                              int*  fileDescriptor ) 
{
  FILE* file=NULL ;
...
void vtkPhastaReaderDev::closefile( int* fileDescriptor, 
                                const char mode[] ) 
{
  char* imode = StringStripper( mode );
...
void vtkPhastaReaderDev::readheader( int* fileDescriptor,
...
void vtkPhastaReaderDev::readdatablock( int*  fileDescriptor,
                                   const char keyphrase[],
                                   void* valueArray,
                                   int*  nItems,
                                   const char  datatype[],
...
vtkPhastaReaderDev::vtkPhastaReaderDev()
{
  this->GeometryFileName = NULL;
  this->FieldFileName = NULL;
  this->SetNumberOfInputPorts(0);
  this->Internal = new vtkPhastaReaderDevInternal;
  this->CachedGrid = 0;
}
...
void vtkPhastaReaderDev::ClearFieldInfo()
{
  this->Internal->FieldInfoMap.clear();
}

void vtkPhastaReaderDev::SetFieldInfo(const char* paraviewFieldTag,
                                   ...
                                   const char* dataType)
{
  vtkPhastaReaderDevInternal::FieldInfo &info =
...
int vtkPhastaReaderDev::RequestData(vtkInformation*,
...
void vtkPhastaReaderDev::ReadGeomFile(char* geomFileName,
                                   int &firstVertexNo,
                                   vtkPoints *points,
                                   int &num_nodes,
                                   int &num_cells)
...
void vtkPhastaReaderDev::ReadFieldFile(char* fieldFileName, 
                                    int, 
                                    ...
                                    int &noOfDatas)
{
  ...
  vtkPhastaReaderDevInternal::FieldInfoMapType::iterator it = this->Internal->FieldInfoMap.begin();
  vtkPhastaReaderDevInternal::FieldInfoMapType::iterator itend = this->Internal->FieldInfoMap.end();
  for(; it!=itend; it++)
    {
...
void vtkPhastaReaderDev::PrintSelf(ostream& os, vtkIndent indent)
{
