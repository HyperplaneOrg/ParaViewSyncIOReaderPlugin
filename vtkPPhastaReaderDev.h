...
=========================================================================*/
// .NAME vtkPPhastaReaderDev - parallel Phasta meta-file reader
// vtkPPhastaReaderDev reads XML based Phasta meta-files and the underlying
...
#ifndef __vtkPPhastaReaderDev_h
#define __vtkPPhastaReaderDev_h
...
class VTKPVVTKEXTENSIONSDEFAULT_EXPORT vtkPPhastaReaderDev : public vtkMultiBlockDataSetAlgorithm
{
public:
  static vtkPPhastaReaderDev* New();
  vtkTypeMacro(vtkPPhastaReaderDev, vtkMultiBlockDataSetAlgorithm);
...
private:
  vtkPPhastaReaderDevInternal* Internal;
  
  vtkPPhastaReaderDev(const vtkPPhastaReaderDev&);  // Not implemented.
  void operator=(const vtkPPhastaReaderDev&);  // Not implemented.
};
